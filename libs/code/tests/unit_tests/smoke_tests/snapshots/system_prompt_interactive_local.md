...
Example: `python -c "import runpy; from pathlib import Path; runpy.run_path(str(Path(r'<deepagents_home>/agent/skills/web-research/script.py').expanduser()), run_name='__main__')"`
