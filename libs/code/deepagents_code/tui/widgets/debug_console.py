...
class _DebugLogView(ScrollView, can_focus=True):
    ...
    def _select_record(self, index: int) -> None:
        ...
        self.refresh()
        # Re-apply after Textual commits any pending virtual-size/layout update;
        # the immediate scroll can otherwise clamp against stale bounds.
        self.call_after_refresh(self._scroll_selected_visible)
