    ...
    try:
        ...
        try:
            ...
            try:
                ...
                # Surface any debug-preserved server-log paths now that Textual
                # has torn down the alternate screen. Keep this unconditional
                # because a failed startup can queue a path without producing a
                # tracked process.
                emit_preserved_log_notices()
