...
def _with_startup_process_cleanup[**RunNonInteractiveP](
    function: Callable[RunNonInteractiveP, Awaitable[int]],
) -> Callable[RunNonInteractiveP, Awaitable[int]]:
    ...
    @wraps(function)
    async def wrapped(
        *args: RunNonInteractiveP.args,
        **kwargs: RunNonInteractiveP.kwargs,
    ) -> int:
