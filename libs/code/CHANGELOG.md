...
## [0.2.0](https://github.com/koboldul/deepagents/compare/deepagents-code==0.1.57...deepagents-code==0.2.0) (2026-08-18)


### ⚠ BREAKING CHANGES

* **sdk,code,quickjs:** make the `ToDoListMiddleware` list opt-in ([#4929](https://github.com/koboldul/deepagents/issues/4929))

### Features

* **code,evals:** GLM-5.2 harness profile ([#4710](https://github.com/koboldul/deepagents/issues/4710)) ([47cfc33](https://github.com/koboldul/deepagents/commit/47cfc33cf9145347b57eb2daf6ef82cdaa342ca4))
...
* **code:** add `--allow-fs-tools` filesystem tool allowlist to dcode ([#4635](https://github.com/koboldul/deepagents/issues/4635)) ([3fbb85e](https://github.com/koboldul/deepagents/commit/3fbb85e3565f270f3a567f771ebd28323f10245d))
...
* **code:** add Hooks v2 capability snapshots ([#4916](https://github.com/koboldul/deepagents/issues/4916)) ([8b4e508](https://github.com/koboldul/deepagents/commit/8b4e508d4664ef02e220854d50f5d98e0913aed8))
* **code:** add Hooks v2 execution engine ([#4880](https://github.com/koboldul/deepagents/issues/4880)) ([f0b198f](https://github.com/koboldul/deepagents/commit/f0b198faa220ad90f24713f08acc09d41e4a81de))
* **code:** add Hooks v2 session transcripts ([#4918](https://github.com/koboldul/deepagents/issues/4918)) ([ca86fbe](https://github.com/koboldul/deepagents/commit/ca86fbecca1a43facb4281397760c5e52edb1ddd))
...
* **code:** add typed hooks data models ([#4870](https://github.com/koboldul/deepagents/issues/4870)) ([0967012](https://github.com/koboldul/deepagents/commit/09670121b8d20fa8029804143852f6fcc6135dba))
...
* **code:** configure Auto goal criteria acceptance ([#4940](https://github.com/koboldul/deepagents/issues/4940)) ([37addfc](https://github.com/koboldul/deepagents/commit/37addfc8bb5533d6670d14defea38770c8d54d1e))
...
* **code:** include `yolo` mode in `Shift+Tab` approval cycle ([#5035](https://github.com/koboldul/deepagents/issues/5035)) ([9f2cc21](https://github.com/koboldul/deepagents/commit/9f2cc212dc3ba59540a9f738d2849e38ac9ecfc2))
...
* **code:** let the rubric grader inspect working-directory files ([#4835](https://github.com/koboldul/deepagents/issues/4835)) ([5dcf749](https://github.com/koboldul/deepagents/commit/5dcf749a6e7d5ab6611f30d485a3382c7ef31f22))
...
* **code:** make Version, Model, CWD copyable in Debug Console ([#4975](https://github.com/koboldul/deepagents/issues/4975)) ([52b8993](https://github.com/koboldul/deepagents/commit/52b8993489a9b6b92be077fe835743ef7704b6a0))
* **code:** migrate legacy hooks to v2 events ([#4971](https://github.com/koboldul/deepagents/issues/4971)) ([fdb585c](https://github.com/koboldul/deepagents/commit/fdb585c87b054979b8440bdc6ac97fc8ae628134))
...
* **code:** raise agent recursion limit to 2000 and make it configurable ([#4994](https://github.com/koboldul/deepagents/issues/4994)) ([94962a5](https://github.com/koboldul/deepagents/commit/94962a5f588ce84991ad382b7713155d6a5a231e))
...
* **code:** show changelog link before install-script update prompt ([#5034](https://github.com/koboldul/deepagents/issues/5034)) ([e3d2a87](https://github.com/koboldul/deepagents/commit/e3d2a870b77e548611929be56952f68825d3d52e))
...
* **code:** support native Windows local mode ([c49102e](https://github.com/koboldul/deepagents/commit/c49102e61d5a20f70bdbfe195c58d087a7508fc4))
...
* **sdk,code,quickjs:** make the `ToDoListMiddleware` list opt-in ([#4929](https://github.com/koboldul/deepagents/issues/4929)) ([9340518](https://github.com/koboldul/deepagents/commit/9340518a26c4287f9ad0c543edc9b69106c15154))


### Bug Fixes

* **code,evals:** unify goal activation signaling ([#4980](https://github.com/koboldul/deepagents/issues/4980)) ([0c4016e](https://github.com/koboldul/deepagents/commit/0c4016e3c8a7293fdf1a24e12340759068a2bb9a))
* **code:** abort YOLO launch on `Ctrl+C`/`Ctrl+D` ([#4953](https://github.com/koboldul/deepagents/issues/4953)) ([e6ab9c0](https://github.com/koboldul/deepagents/commit/e6ab9c05e8fcb9a332396a9425e2b302607be823))
* **code:** allow cleanup of agent-created scratch files ([#4860](https://github.com/koboldul/deepagents/issues/4860)) ([fe08582](https://github.com/koboldul/deepagents/commit/fe08582a386b86f78f7a8047db067ea45e7e2650))
...
* **code:** authorize Auto actions from active goal/rubric directives ([#5017](https://github.com/koboldul/deepagents/issues/5017)) ([728dbe7](https://github.com/koboldul/deepagents/commit/728dbe7df62ad9960f21cabd6e6c37e8d9a66da7))
...
* **code:** avoid redundant Auto approval prompts ([#4993](https://github.com/koboldul/deepagents/issues/4993)) ([9975874](https://github.com/koboldul/deepagents/commit/9975874d897ada8979c084145eb730e15c9cf979))
...
* **code:** consistent modal backdrop dimming for selectors ([#4990](https://github.com/koboldul/deepagents/issues/4990)) ([3606e3f](https://github.com/koboldul/deepagents/commit/3606e3f3fa2faac97f30141f9ee54e37631d16ad))
...
* **code:** dedupe Auto classifier-unavailable transcript spam ([#5013](https://github.com/koboldul/deepagents/issues/5013)) ([9500306](https://github.com/koboldul/deepagents/commit/9500306a17f90dc2f27897c364c24cafffbc474a))
...
* **code:** disable LangSmith secret redaction by default ([#4970](https://github.com/koboldul/deepagents/issues/4970)) ([d029585](https://github.com/koboldul/deepagents/commit/d029585ab79432d00edfa5a70e77a31f2388ed5b))
...
* **code:** flag empty env override shadowing LangSmith key in `/trace` ([#4996](https://github.com/koboldul/deepagents/issues/4996)) ([313f952](https://github.com/koboldul/deepagents/commit/313f9520cef28c105aa53eac645176d422ec4a97))
...
* **code:** give `config get` a useful missing-key message ([#4976](https://github.com/koboldul/deepagents/issues/4976)) ([260c33e](https://github.com/koboldul/deepagents/commit/260c33ee28ade91741ba226ef3e719b6b8c8c02c))
...
* **code:** harden Hooks v2 command execution ([#4917](https://github.com/koboldul/deepagents/issues/4917)) ([05dd0d1](https://github.com/koboldul/deepagents/commit/05dd0d1bee7d79be6ac7f18db0d05b521e760326))
...
* **code:** ignore LangSmith default US endpoint as custom target ([#5022](https://github.com/koboldul/deepagents/issues/5022)) ([ffb7aab](https://github.com/koboldul/deepagents/commit/ffb7aabe25d3d5ad7c5fce139f3bc3e14e245adf))
...
* **code:** improve `/rubric` help and empty-state messaging ([#5015](https://github.com/koboldul/deepagents/issues/5015)) ([1a3f46b](https://github.com/koboldul/deepagents/commit/1a3f46b85861779ed44e880cc7921cdd6f28fdfa))
...
* **code:** inject OpenAI `prompt_cache_key` for any OpenAI-provider endpoint ([#4995](https://github.com/koboldul/deepagents/issues/4995)) ([6d6632f](https://github.com/koboldul/deepagents/commit/6d6632fa39822f1b774fcabd61ed371a90427113))
...
* **code:** keep finished calls on live tool-group line ([#4927](https://github.com/koboldul/deepagents/issues/4927)) ([976c54b](https://github.com/koboldul/deepagents/commit/976c54b2e1392282044d9890a4a5d5d655f3e8dc))
* **code:** keep harness-profile diagnostics out of terminal output ([#4943](https://github.com/koboldul/deepagents/issues/4943)) ([812bae4](https://github.com/koboldul/deepagents/commit/812bae4afad6749add097f9d58e489df9ec703a2))
...
* **code:** log underlying Auto classifier failures ([#5011](https://github.com/koboldul/deepagents/issues/5011)) ([bd03e8a](https://github.com/koboldul/deepagents/commit/bd03e8a1ca4b38883e11148d5614a444cdefa407))
...
* **code:** make Auto mode generally available ([#4957](https://github.com/koboldul/deepagents/issues/4957)) ([1709dbf](https://github.com/koboldul/deepagents/commit/1709dbf9b27766aacce1a5a9c17396b3654f026c))
...
* **code:** make YOLO warning friendlier for new users ([#4950](https://github.com/koboldul/deepagents/issues/4950)) ([fe07f39](https://github.com/koboldul/deepagents/commit/fe07f39ad78c5c09ea6959540a49196cd2f47f3e))
* **code:** offload blocking IO during server graph build ([0a1d0e7](https://github.com/koboldul/deepagents/commit/0a1d0e731c807c6cbbcd867d4cfc3a9a6b4ca50a))
...
* **code:** omit `plugins/` and `conversation_history/` from `/agent` picker ([#4991](https://github.com/koboldul/deepagents/issues/4991)) ([db26688](https://github.com/koboldul/deepagents/commit/db26688eee32232a1b73e98cc02642b5bf4165f4))
...
* **code:** prevent failed exit setup from stranding the app ([#4913](https://github.com/koboldul/deepagents/issues/4913)) ([e4d69b0](https://github.com/koboldul/deepagents/commit/e4d69b04a84de226d26d9ca3adea96f1337eef04))
...
* **code:** put field descriptions on first-party tool schemas ([#5019](https://github.com/koboldul/deepagents/issues/5019)) ([4ccb873](https://github.com/koboldul/deepagents/commit/4ccb87325f3f97e416683233c94405e3ee105cda))
...
* **code:** report Auto classifier timeout budget ([#5025](https://github.com/koboldul/deepagents/issues/5025)) ([516619b](https://github.com/koboldul/deepagents/commit/516619b7bf516e56f0e56ebc319dcab928c68c40))
...
* **code:** restore `"Server log preserved at:"` notice on exit ([#4999](https://github.com/koboldul/deepagents/issues/4999)) ([5bc7714](https://github.com/koboldul/deepagents/commit/5bc7714fe55a73ac4892deb1785522ea310607ce))
...
* **code:** route `ctrl+x` to focused `ask_user` input ([#4926](https://github.com/koboldul/deepagents/issues/4926)) ([005f9bb](https://github.com/koboldul/deepagents/commit/005f9bb4d790e6cd92be8712ec86cd45192b699f))
...
* **code:** share MCP approvals across Git worktrees ([#4939](https://github.com/koboldul/deepagents/issues/4939)) ([467f9dd](https://github.com/koboldul/deepagents/commit/467f9dd0400087c2918bcf19f270bd934cec623a))
...
* **code:** show `-m` prompt as queued immediately on startup ([#4861](https://github.com/koboldul/deepagents/issues/4861)) ([d0e148a](https://github.com/koboldul/deepagents/commit/d0e148a72612137fc7bc1e49a8972643e0ca2c28))
* **code:** show Auto enable notice modal only on first global enable ([#5012](https://github.com/koboldul/deepagents/issues/5012)) ([c2dbd17](https://github.com/koboldul/deepagents/commit/c2dbd176f06ff1a29637107101ae61344a09fc59))
...
* **code:** show rubric grader defaults ([#4966](https://github.com/koboldul/deepagents/issues/4966)) ([465b9de](https://github.com/koboldul/deepagents/commit/465b9de17f9f4e6cd07a8674d9a186e60f5bf4d4))
...
* **code:** skip grading during `/goal` proposals ([#4941](https://github.com/koboldul/deepagents/issues/4941)) ([d1ce66e](https://github.com/koboldul/deepagents/commit/d1ce66ea03e3726e6077c6700fc480209a849a7e))
...
* **code:** thread id always copies on click in Debug Console ([#4945](https://github.com/koboldul/deepagents/issues/4945)) ([b4cb393](https://github.com/koboldul/deepagents/commit/b4cb3937bf8883e616f47621547a775ce9b29995))
...
* **code:** trim `web_search` and `fetch_url` tool descriptions ([#5016](https://github.com/koboldul/deepagents/issues/5016)) ([170b4a6](https://github.com/koboldul/deepagents/commit/170b4a6c4590b3f95fb5219b5d9074c7f01a1937))
...
* **code:** use SDK pin as effective editable version ([#4949](https://github.com/koboldul/deepagents/issues/4949)) ([1b270c8](https://github.com/koboldul/deepagents/commit/1b270c86fe24381c28d3ed35a31d754bd58bbf6e))
...
* **code:** speed up local context detection ([#4922](https://github.com/koboldul/deepagents/issues/4922)) ([0b512d4](https://github.com/koboldul/deepagents/commit/0b512d4b79b1a03c7e452f1e76350cf726b1ec38))


### Reverted Changes

* **code,sdk:** revert `SystemPromptConfig` ([#4969](https://github.com/koboldul/deepagents/issues/4969)) ([d046427](https://github.com/koboldul/deepagents/commit/d046427b536c8ddbce5d804d6ae8b860511a9b44))
