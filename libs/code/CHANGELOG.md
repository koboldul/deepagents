...
## [0.1.69](https://github.com/koboldul/deepagents/compare/deepagents-code==0.1.68...deepagents-code==0.1.69) (2026-09-11)
...
* **code:** add `/summarization-model` ([#5884](https://github.com/koboldul/deepagents/issues/5884)) ([4f34c51](https://github.com/koboldul/deepagents/commit/4f34c51d4b9f6ed508af6a8e1ca6dbcf6e3e3877))
...
* **code:** add `GPT-6 Astra` support ([#6141](https://github.com/koboldul/deepagents/issues/6141)) ([048f989](https://github.com/koboldul/deepagents/commit/048f9890bfe8b640e1e72085a4fa50d9084545f0))
...
* **code:** add Baseten `zai-org/GLM-5.3-Flash` to model switcher ([#5844](https://github.com/koboldul/deepagents/issues/5844)) ([731d2d5](https://github.com/koboldul/deepagents/commit/731d2d5a56dc0f9e78cec77722af592ad939edd3))
* **code:** add extension trust and inspection UX ([#5634](https://github.com/koboldul/deepagents/issues/5634)) ([da5dcdc](https://github.com/koboldul/deepagents/commit/da5dcdc1df38218f50d57be37908bc39438e3f2b))
...
* **code:** add optional extra uninstall commands ([#5875](https://github.com/koboldul/deepagents/issues/5875)) ([d36f226](https://github.com/koboldul/deepagents/commit/d36f22694d4b5d9ac9fa806292389954861cd53b))
* **code:** attribute skill invocations in trace metadata ([#5925](https://github.com/koboldul/deepagents/issues/5925)) ([68fa627](https://github.com/koboldul/deepagents/commit/68fa627522e60fe5d5278b454d21fa63a40b2d35))
* **code:** bind conversations to a recorded workspace ([#5946](https://github.com/koboldul/deepagents/issues/5946)) ([4ca758e](https://github.com/koboldul/deepagents/commit/4ca758ed8efd9b586b26685bc3dc787501f3d502))
...
* **code:** configure and load Python extensions ([#5632](https://github.com/koboldul/deepagents/issues/5632)) ([017d7ae](https://github.com/koboldul/deepagents/commit/017d7ae41fe1dfe3fe7fa07bfa206959170707ed))
...
* **code:** copy current model from picker header ([#5904](https://github.com/koboldul/deepagents/issues/5904)) ([cfd9e7a](https://github.com/koboldul/deepagents/commit/cfd9e7aedfd4438d284bf5b567dbc858936af2e4))
* **code:** default Auto classifier by provider ([#6039](https://github.com/koboldul/deepagents/issues/6039)) ([99ed6c8](https://github.com/koboldul/deepagents/commit/99ed6c83238851eb334e19b27d3faec8869fc9a7))
* **code:** default general-purpose subagents to fork mode ([#6024](https://github.com/koboldul/deepagents/issues/6024)) ([d3ad134](https://github.com/koboldul/deepagents/commit/d3ad134a49287d80b9897b0ef38b4635f8d7de94))
...
* **code:** define and discover Python extensions ([#5631](https://github.com/koboldul/deepagents/issues/5631)) ([738bf07](https://github.com/koboldul/deepagents/commit/738bf077f8b079164f11742bfcaa2fa93df138d7))
...
* **code:** host Python extensions in the agent runtime ([#5633](https://github.com/koboldul/deepagents/issues/5633)) ([2c8d154](https://github.com/koboldul/deepagents/commit/2c8d154c7616071919cab4947403dff701e74b31))
* **code:** limit thread resume age ([#6068](https://github.com/koboldul/deepagents/issues/6068)) ([318311f](https://github.com/koboldul/deepagents/commit/318311f56c3d3b9c4af4ece22fcfc387eeece5cc))
* **code:** link doctor commit hash to GitHub ([#5920](https://github.com/koboldul/deepagents/issues/5920)) ([c9e6f55](https://github.com/koboldul/deepagents/commit/c9e6f55c3ee4b6efedfc945fd1c9b160e6e2a872))
* **code:** list MCP servers needing login ([#5867](https://github.com/koboldul/deepagents/issues/5867)) ([a71cafd](https://github.com/koboldul/deepagents/commit/a71cafdbbd851db65dc311eebe5574982866b222))
...
* **code:** model-node retry middleware for transient model errors ([#4569](https://github.com/koboldul/deepagents/issues/4569)) ([948fea8](https://github.com/koboldul/deepagents/commit/948fea88e2c1e0660a3c1c7a077121c573f11675))
...
* **code:** open summarization model picker ([#5932](https://github.com/koboldul/deepagents/issues/5932)) ([f90d4fe](https://github.com/koboldul/deepagents/commit/f90d4fe114efe1de1e3d8dd8e5aee5b9f631093d))
* **code:** optionally show visible reasoning ([#5887](https://github.com/koboldul/deepagents/issues/5887)) ([457ac43](https://github.com/koboldul/deepagents/commit/457ac435e1216d3f7cac76d4e856b7aa020b5ea8))
...
* **code:** recommend GLM 5.3 models ([#6211](https://github.com/koboldul/deepagents/issues/6211)) ([e7e88d5](https://github.com/koboldul/deepagents/commit/e7e88d5efaf2bbce33237ea323fb68487eabd721))
...
* **code:** reuse server across workspace switches ([#6152](https://github.com/koboldul/deepagents/issues/6152)) ([ca2d1ef](https://github.com/koboldul/deepagents/commit/ca2d1ef7f270d0fa1040e5473f43e99937b5f03f))
...
* **code:** standardize external editor shortcut ([#5911](https://github.com/koboldul/deepagents/issues/5911)) ([f75300f](https://github.com/koboldul/deepagents/commit/f75300f12dc363132dc187e674cf3cd52eb93595))
...
* **code:** trace effective approval mode ([#5972](https://github.com/koboldul/deepagents/issues/5972)) ([c56958d](https://github.com/koboldul/deepagents/commit/c56958d633cd9513ba699f940d4fadfee6cd3963))
...
* **code,evals:** allow instrumental Auto actions ([#5832](https://github.com/koboldul/deepagents/issues/5832)) ([56f51d8](https://github.com/koboldul/deepagents/commit/56f51d83a7d6621f2c3954ce69740c46e3cc1426))
* **code:** accept bare relative paths in marketplace plugin sources ([#5959](https://github.com/koboldul/deepagents/issues/5959)) ([28468d6](https://github.com/koboldul/deepagents/commit/28468d62f208e3dea5a574898d19e7d9618db928))
...
* **code:** bind request-time working directories ([#5968](https://github.com/koboldul/deepagents/issues/5968)) ([98db566](https://github.com/koboldul/deepagents/commit/98db566f2cc654a535ed68de4dbdd2e10a2edd30))
...
* **code:** bound transcript tail reconciliation ([#6057](https://github.com/koboldul/deepagents/issues/6057)) ([8da3264](https://github.com/koboldul/deepagents/commit/8da32644dc7dcad1125a840bc17ec3d5ea66b8c3))
* **code:** cap MCP tool names for provider compatibility ([#5953](https://github.com/koboldul/deepagents/issues/5953)) ([0eb8e57](https://github.com/koboldul/deepagents/commit/0eb8e578708a18c3a789f76c4bb13d92bd768192))
...
* **code:** clarify clear command descriptions ([#5841](https://github.com/koboldul/deepagents/issues/5841)) ([a6b069d](https://github.com/koboldul/deepagents/commit/a6b069db380c5483c414f48d9b57899c749c8528))
...
* **code:** complete ASCII UI fallbacks ([#5930](https://github.com/koboldul/deepagents/issues/5930)) ([e9a1623](https://github.com/koboldul/deepagents/commit/e9a16234f14ea570e04a936cf8070156d01eae99))
...
* **code:** confirm server restart for workspace switch ([#6178](https://github.com/koboldul/deepagents/issues/6178)) ([7997203](https://github.com/koboldul/deepagents/commit/7997203245915aa83e87db83252c04391bd00440))
...
* **code:** defer the recursion limit to the LangGraph server ([#5882](https://github.com/koboldul/deepagents/issues/5882)) ([4379a46](https://github.com/koboldul/deepagents/commit/4379a463a181a978aab206e93cdcc0788f7eac2b))
* **code:** demote no-output hint suppression to debug ([#6245](https://github.com/koboldul/deepagents/issues/6245)) ([d93ab33](https://github.com/koboldul/deepagents/commit/d93ab3351bbf4c3687212f665094ccad100f2c08))
* **code:** disable Git terminal prompts in `execute` ([#5878](https://github.com/koboldul/deepagents/issues/5878)) ([a535b61](https://github.com/koboldul/deepagents/commit/a535b610a158a79a2629fac73fa788d7b31f4096))
...
* **code:** flush traces before server shutdown ([#5837](https://github.com/koboldul/deepagents/issues/5837)) ([804fdcc](https://github.com/koboldul/deepagents/commit/804fdcc436538686ca345965c0511e0664eb7c34))
...
* **code:** guard path expansion in the Auto approval gate ([#5941](https://github.com/koboldul/deepagents/issues/5941)) ([46dea07](https://github.com/koboldul/deepagents/commit/46dea076a77f2b580829b5a211469c68b8924f2a))
...
* **code:** hide inactive F2 tool hint ([#5939](https://github.com/koboldul/deepagents/issues/5939)) ([fd7ba1a](https://github.com/koboldul/deepagents/commit/fd7ba1ac47e9afbf7a60a40010f72130ff47ee25))
...
* **code:** hide MCP token path outside debug mode ([#5866](https://github.com/koboldul/deepagents/issues/5866)) ([bd79104](https://github.com/koboldul/deepagents/commit/bd791048b3dfafae3df81e89aa81388e26bc9667))
...
* **code:** isolate debug logs by thread ([#5921](https://github.com/koboldul/deepagents/issues/5921)) ([4358cce](https://github.com/koboldul/deepagents/commit/4358ccee79dc9350600af02e4e52633b919d7382))
* **code:** isolate LangSmith auth and workspace tracing ([#6061](https://github.com/koboldul/deepagents/issues/6061)) ([794eda8](https://github.com/koboldul/deepagents/commit/794eda83b777a2a7278e5726607e4b305801298d))
* **code:** isolate parallel `task` failures ([#5954](https://github.com/koboldul/deepagents/issues/5954)) ([e0a474f](https://github.com/koboldul/deepagents/commit/e0a474fed575992abc991f6a8049cc8e18e328c0))
...
* **code:** make debug log path click-to-copy ([#5845](https://github.com/koboldul/deepagents/issues/5845)) ([1fc7d1e](https://github.com/koboldul/deepagents/commit/1fc7d1e26d21ff27327b1b0c0a926673c4663001))
...
* **code:** move editable path to debug console ([#5850](https://github.com/koboldul/deepagents/issues/5850)) ([e85f4b7](https://github.com/koboldul/deepagents/commit/e85f4b7bd0acc696a3f29f5c298d3353d7d5495f))
* **code:** name models in classifier errors ([#6038](https://github.com/koboldul/deepagents/issues/6038)) ([fff2c77](https://github.com/koboldul/deepagents/commit/fff2c77c755c6d9dce3a6f776a9b94599ad05cfd))
* **code:** offload server config import ([#6089](https://github.com/koboldul/deepagents/issues/6089)) ([90fe4f4](https://github.com/koboldul/deepagents/commit/90fe4f4ac0a1311f1527b1a5cd02bd3ac8664580))
...
* **code:** parse extra skill dirs with platform separator ([#6151](https://github.com/koboldul/deepagents/issues/6151)) ([56e4ef1](https://github.com/koboldul/deepagents/commit/56e4ef1a5f447950a04ba37a7855c8e0babd2f11))
...
* **code:** point model switch warning to `/offload` ([#5901](https://github.com/koboldul/deepagents/issues/5901)) ([2f4d606](https://github.com/koboldul/deepagents/commit/2f4d606ee338720dd6ae6758761f08c3cb9c2350))
...
* **code:** price Fireworks GLM-5.3 Flash usage ([#6223](https://github.com/koboldul/deepagents/issues/6223)) ([d3627ea](https://github.com/koboldul/deepagents/commit/d3627eaaeda2de62c19b0647ac29f80767057241))
* **code:** price Fireworks GLM-5.3 usage ([#6221](https://github.com/koboldul/deepagents/issues/6221)) ([07c5d2e](https://github.com/koboldul/deepagents/commit/07c5d2ecfe5db6238eff782f714fbbe08865e8d4))
...
* **code:** record Auto classifier deadline as a traced error ([#5944](https://github.com/koboldul/deepagents/issues/5944)) ([9a643c7](https://github.com/koboldul/deepagents/commit/9a643c75843a95d3ef770ac69dd1452435596efe))
* **code:** recover stale pending work before compaction ([#5909](https://github.com/koboldul/deepagents/issues/5909)) ([213f0c8](https://github.com/koboldul/deepagents/commit/213f0c8a7dd01febff2a52c9ca0ea61b2cd8fd9d))
...
* **code:** refuse a second sandbox workspace ([#5979](https://github.com/koboldul/deepagents/issues/5979)) ([cb4c973](https://github.com/koboldul/deepagents/commit/cb4c973172f7838eefa328ea0c6ca334b6aaab98))
* **code:** reject stale successful updates ([#5847](https://github.com/koboldul/deepagents/issues/5847)) ([23976f4](https://github.com/koboldul/deepagents/commit/23976f414a928eb50d13d351bdc19971098ea7b9))
...
* **code:** render thread timestamps without the glibc-only `%-I` strftime flag ([#5886](https://github.com/koboldul/deepagents/issues/5886)) ([ef6b5be](https://github.com/koboldul/deepagents/commit/ef6b5beec93bdcbb38ea44f157a029bc07b8b5ee))
...
* **code:** resolve project policy per workspace ([#6064](https://github.com/koboldul/deepagents/issues/6064)) ([ea1f253](https://github.com/koboldul/deepagents/commit/ea1f2536537efb01c71dce54c46894b9318c4f80))
* **code:** respect ASCII mode in splash border ([#5923](https://github.com/koboldul/deepagents/issues/5923)) ([437c2db](https://github.com/koboldul/deepagents/commit/437c2dbbe287c6b37a4fe7466b5f9d5305163d85))
* **code:** retry interrupted model streams ([#5905](https://github.com/koboldul/deepagents/issues/5905)) ([dfcd941](https://github.com/koboldul/deepagents/commit/dfcd9417a88c774a232de33e41bb0e69d76ec7ce))
* **code:** run sandbox creation and entry off the guarded event loop ([#6017](https://github.com/koboldul/deepagents/issues/6017)) ([fd28bfb](https://github.com/koboldul/deepagents/commit/fd28bfb5c5e1ca18af975d8e57d361c1c23f81b7))
* **code:** say which source path a plugin install rejected ([#5960](https://github.com/koboldul/deepagents/issues/5960)) ([6f8c488](https://github.com/koboldul/deepagents/commit/6f8c48800b02397fd262bfd9caea5096984d4220))
* **code:** scope project dotenv to workspaces ([#5980](https://github.com/koboldul/deepagents/issues/5980)) ([678c115](https://github.com/koboldul/deepagents/commit/678c11559d7534ee5e16ceebfacf01eeb6536ac7))
...
* **code:** serialize transcript tail reconciliation ([#6143](https://github.com/koboldul/deepagents/issues/6143)) ([5fb8b69](https://github.com/koboldul/deepagents/commit/5fb8b699843ecf93debc592d9dbb8a534f54db09))
...
* **code:** show bound workspace in shell approvals ([#5966](https://github.com/koboldul/deepagents/issues/5966)) ([716ab9f](https://github.com/koboldul/deepagents/commit/716ab9fb9c1f27d912aac89a663a75c4861418a5))
...
* **code:** silence absent themes config warning ([#6220](https://github.com/koboldul/deepagents/issues/6220)) ([b93f748](https://github.com/koboldul/deepagents/commit/b93f7483bb5722bbae281a19a80a7aea21d38832))
...
* **code:** skip unchanged config writes ([#5919](https://github.com/koboldul/deepagents/issues/5919)) ([c313ff0](https://github.com/koboldul/deepagents/commit/c313ff0e6b3549d9f959578ae177291d8c8f13a3))
* **code:** skip uncorrelated-result warning for auto-mode policy denials ([#5869](https://github.com/koboldul/deepagents/issues/5869)) ([35fd008](https://github.com/koboldul/deepagents/commit/35fd00833a03e9e76858195aae8b13e7753cfa47))
...
* **code:** standardize recent-thread environment variable ([#6205](https://github.com/koboldul/deepagents/issues/6205)) ([a4c218e](https://github.com/koboldul/deepagents/commit/a4c218e185bc49a11a381c3afde91f6efa7226fc))
...
* **code:** surface stale updates in-session ([#6063](https://github.com/koboldul/deepagents/issues/6063)) ([cdb9d4c](https://github.com/koboldul/deepagents/commit/cdb9d4c30f4419c0eb2c98ad53940875e4dfbe9e))
* **code:** surface the LangSmith credential in `dcode config` ([#6083](https://github.com/koboldul/deepagents/issues/6083)) ([a1a0887](https://github.com/koboldul/deepagents/commit/a1a0887f7e42d0f8515ad415c9b9062e89350e8c))
...
* **code:** treat effort changes as cache identity for OpenAI and Anthropic ([#6196](https://github.com/koboldul/deepagents/issues/6196)) ([cacd50a](https://github.com/koboldul/deepagents/commit/cacd50adc365e949e4f0b9a7e94ad6f8eeb7d497))
* **code:** update rubric grader model without restart ([#5885](https://github.com/koboldul/deepagents/issues/5885)) ([428e760](https://github.com/koboldul/deepagents/commit/428e760668d8fdfbb920966e2969c76040e30745))
* **code:** use sharp splash border ([#5970](https://github.com/koboldul/deepagents/issues/5970)) ([096d20c](https://github.com/koboldul/deepagents/commit/096d20cc7f0d61ed027686b226217f4a717925b0))
* **code:** wait for graph readiness after server restart ([#5947](https://github.com/koboldul/deepagents/issues/5947)) ([358bc33](https://github.com/koboldul/deepagents/commit/358bc3347135793afd12b8b387bda94e61bb6f07))
...
* **code,quickjs:** omit middleware trace inputs ([#6015](https://github.com/koboldul/deepagents/issues/6015)) ([673844d](https://github.com/koboldul/deepagents/commit/673844d06fe0ee186f2e492c3c0a19ec5facffc2))
